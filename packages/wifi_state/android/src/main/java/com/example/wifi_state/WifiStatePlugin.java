...
public class WifiStatePlugin implements FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
    ...
    private EventChannel channelEvent;
    Context context;
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        channelEvent = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "wifi_state_plugin_eventChannel");
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull final Result result) {
        ...
        } else if (call.method.equals("sendNotification")) {
            String title = call.argument("title");
            String message = call.argument("message");
            sendNotification(title, message);
        } else if (call.method.equals("startWifiListen")) {
            result.success(null);
